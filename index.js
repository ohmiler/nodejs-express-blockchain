...
app.post('/blockchain', Controller.validateNewChain, Controller.createNewChain);
app.get('/blockchain/', Controller.getChain);
app.post('/blockchain/append', Controller.appendNewChild);

app.listen(9090, () => {
    console.log('App starting on port 9090');
});